...
3. Continue the formal BUTD ScanRefer Full checkpoint from epoch 65 with the same optimizer, scheduler, module flags, and fused official score. Stop only after a durable checkpoint strictly exceeds Acc@0.25 = 0.5391, or after epoch 80 if the target is not reached.
