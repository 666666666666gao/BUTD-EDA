...
OUT="$ROOT/stage61_binary50_full_train_refit"
RESULT="$ROOT/stage62_binary50_full_train_locked_val_eval.json"
SCRIPT="$P/refit_locked_binary50_ranker.py"
...
MODEL="$OUT/binary50_option_ranker_full_train.txt"
LOCK="$OUT/locked_binary50_full_train_policy.json"
...
s = r['selected']
print('STAGE62_FULL_TRAIN_LOCKED_VAL acc025={:.10f} acc050={:.10f} '
      'strict_goal={}'.format(
          s['acc025'], s['acc050'],
