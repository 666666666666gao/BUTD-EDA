...
CHECKPOINT="${1:?usage: verify_stage4_reload.sh CHECKPOINT QUALITY_WEIGHT CALIBRATION_JSON}"
QUALITY_WEIGHT="${2:?usage: verify_stage4_reload.sh CHECKPOINT QUALITY_WEIGHT CALIBRATION_JSON}"
CALIBRATION_JSON="${3:?usage: verify_stage4_reload.sh CHECKPOINT QUALITY_WEIGHT CALIBRATION_JSON}"
...
VERIFY_ROOT="/root/autodl-tmp/logs/butd_acc50_target_20260827/stage4_reload_verify"
