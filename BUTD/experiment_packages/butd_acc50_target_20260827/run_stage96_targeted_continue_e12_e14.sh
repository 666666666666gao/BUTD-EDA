...
OUT="/root/autodl-tmp/logs/butd_acc50_target_20260827/stage96_targeted_continue_e12_e14"
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES}" "${CMD[@]}" 2>&1 | tee "${P}/stage96_train.log"
