...
SCRIPT="${P}/stage113_ranker_threshold_audit.py"
...
OUT="${ROOT}/stage118_stage117_threshold_audit"
RESULT="${OUT}/stage118_threshold_audit.json"
RECEIPT="${OUT}/stage118_receipt.json"
STATUS="${P}/stage118_stage117_threshold_audit_status.txt"

EXPECTED_SCRIPT_SHA="2afb652dda767384b6e8b31ff8780609504268d3813eb2c3e7ac832320d4061c"
