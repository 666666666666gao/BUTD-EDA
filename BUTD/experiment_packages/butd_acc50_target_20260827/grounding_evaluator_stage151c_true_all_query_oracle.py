...
class GroundingEvaluator:
    ...
    def _record_detector_topk_compact(
        ...
        # `num_obj` at this call site is the number of evaluation GT boxes,
        # not the number of predicted queries.  The true Oracle must cover
        # every predicted box/query.
        all_query_count = int(pred_bbox.shape[0])
