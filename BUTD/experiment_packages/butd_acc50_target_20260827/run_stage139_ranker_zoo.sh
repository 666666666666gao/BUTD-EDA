...
OUTDIR="$ROOT/stage139_stage135c_ranker_zoo"
RESULT="$OUTDIR/stage139_ranker_zoo.json"
LOG="$OUTDIR/stage139.log"
...
{
  printf 'stage=139_stage135c_ranker_zoo\n'
...
test -s "$RESULT"
sha256sum "$RESULT" > "$OUTDIR/stage139_ranker_zoo.json.sha256"
