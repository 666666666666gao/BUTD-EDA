...
OUT="/root/autodl-tmp/logs/butd_acc50_target_20260827/stage13_textcid_e5_dump"
...
LIVE_BACKUP="${P}/state/stage13_textcid_e5_dump_20260828"

[ ! -e "${OUT}" ] || { echo "refusing to overwrite ${OUT}" >&2; exit 213; }
[ -f "${CKPT}" ] && [ -f "${PATCHED}" ]
assert_gpu_idle
assert_storage
