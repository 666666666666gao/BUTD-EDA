...
EARLY_STOP_MIN_EPOCH="${NMV2_EARLY_STOP_MIN_EPOCH:-35}"
EARLY_STOP_PATIENCE="${NMV2_EARLY_STOP_PATIENCE:-4}"
EARLY_STOP_MIN_DELTA="${NMV2_EARLY_STOP_MIN_DELTA:-0.001}"
...
CMD=(
  ...
  --early_stopping
  --early_stopping_metric last__bbs_acc0.25_top1
