...
def main():
    ...
    for audit in (a1, a2):
        ...
        require(protocol["epochs"] == "1-65 fixed", "epoch protocol differs")
        require(protocol["lr_scheduler"] == "step", "LR scheduler differs")
        require(protocol["lr_decay_epochs"] == [55, 60], "LR milestones differ")
