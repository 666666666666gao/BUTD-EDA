...
NMV2_LR_DECAY_EPOCHS=${NMV2_LR_DECAY_EPOCHS:-"65"}
...
CMD=(
  ...
  --use_rapf --use_reliability_gate --rapf_gate_loss_weight 0
  --use_quality_head --rapf_use_quality
  --use_qahnl --eval_use_fused_scores
  --log_dir "${NMV2_LOG_ROOT}/scanrefer/two_stage/06_full_no_gate_supervision"
