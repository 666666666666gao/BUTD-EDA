...
export DIAG=1
export NMV2_LOG_ROOT='/home/gb/new butd/butd_detr-main/logs/butd_universal_target/nr3d_bbs_aligned_active_eval'
export EXTRA_ARGS='--eval --checkpoint_path logs/butd_universal_target/officialdet_finetune_e1/nr3d/03_full_sacr_rapf_qahnl/nr3d_spacy/1786638278/ckpt_epoch_1.pth'
bash scripts/new_method_v2/nr3d/03_full_sacr_rapf_qahnl_nr3d.sh \
  > logs/butd_universal_target/nr3d_bbs_aligned_active_eval.launch.log 2>&1
