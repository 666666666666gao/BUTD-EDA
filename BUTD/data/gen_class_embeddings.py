...
tokenizer = RobertaTokenizerFast.from_pretrained('/root/autodl-tmp/DATA_ROOT/roberta-base')
text_encoder = RobertaModel.from_pretrained('/root/autodl-tmp/DATA_ROOT/roberta-base')
